...
# def replace_icon_path(svg, svg_icon):
#     path_start_index = svg.index("<path")
...
def derive_translate_coordinates(svg, service_name):
    ...
    svg_icon = paths[0]
    #svg_icon = svg_icon.scaled(0.65, 0.65)
    
    #replace_icon_path(svg, svg_icon)
    ...
    icon_midpoint = svg_icon_x_start + svg_icon_width
...
def add_text_as_svg(svg, service_name):
    ...
    new = svg[:path_end_index+7] + \
        build_text_as_svg(service_name) + svg[path_end_index+7:]
